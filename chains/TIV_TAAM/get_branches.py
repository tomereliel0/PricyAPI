#!/usr/bin/env python3
"""Build TIV_TAAM branches.json from the latest Stores file in links-map.json."""
...
def parse_args() -> argparse.Namespace:
	...
	parser = argparse.ArgumentParser(description="Fetch and normalize TIV_TAAM branches")
