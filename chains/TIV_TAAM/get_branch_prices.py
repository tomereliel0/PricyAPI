#!/usr/bin/env python3
"""Fetch and normalize TIV_TAAM prices for a single store_id."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Fetch and normalize TIV_TAAM branch prices")
    ...
    parser.add_argument("--output", default=None, help="Output JSON path (default: chains/TIV_TAAM/prices/{store_id}.json)")
