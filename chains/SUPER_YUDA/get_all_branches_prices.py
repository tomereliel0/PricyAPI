#!/usr/bin/env python3
"""Fetch prices for all SUPER_YUDA branches using get_branch_prices.py."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Fetch prices for all SUPER_YUDA branches")
...
def is_missing_price_file_result(result: Dict[str, object]) -> bool:
    ...
    return "no price file found for store_id=" in blob
