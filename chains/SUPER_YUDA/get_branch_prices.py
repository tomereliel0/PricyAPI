#!/usr/bin/env python3
"""Fetch and normalize SUPER_YUDA prices for a single store_id."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Fetch and normalize SUPER_YUDA branch prices")
    ...
    parser.add_argument("--output", default=None, help="Output JSON path (default: chains/SUPER_YUDA/prices/{store_id}.json)")
...
def main() -> int:
    ...
    try:
        ...
        auth_opener = None
        if download_url.startswith("https://publishedprices.co.il/file/d/"):
