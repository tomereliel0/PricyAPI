#!/usr/bin/env python3
"""Fetch prices for all FRESHMARKET branches using get_branch_prices.py."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Fetch prices for all FRESHMARKET branches")
