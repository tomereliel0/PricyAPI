#!/usr/bin/env python3
"""Fetch and normalize FRESHMARKET prices for a single store_id."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Fetch and normalize FRESHMARKET branch prices")
    ...
    parser.add_argument("--output", default=None, help="Output JSON path (default: chains/FRESHMARKET/prices/{store_id}.json)")
