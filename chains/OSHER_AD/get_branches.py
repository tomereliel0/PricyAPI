#!/usr/bin/env python3
"""Build OSHER_AD branches.json from the latest Stores file in links-map.json."""
...
def parse_args() -> argparse.Namespace:
	...
	parser = argparse.ArgumentParser(description="Fetch and normalize OSHER_AD branches")
