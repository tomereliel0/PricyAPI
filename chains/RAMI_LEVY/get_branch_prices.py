#!/usr/bin/env python3
"""Fetch and normalize RAMI_LEVY prices for a single store_id."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Fetch and normalize RAMI_LEVY branch prices")
    ...
    parser.add_argument("--output", default=None, help="Output JSON path (default: chains/RAMI_LEVY/prices/{store_id}.json)")
