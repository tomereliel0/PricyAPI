#!/usr/bin/env python3
"""Fetch and normalize CARREFOUR prices for a single store_id."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Fetch and normalize CARREFOUR branch prices")
    ...
    parser.add_argument("--output", default=None, help="Output JSON path (default: chains/CARREFOUR/prices/{store_id}.json)")
