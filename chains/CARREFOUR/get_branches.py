#!/usr/bin/env python3
"""Build CARREFOUR branches.json from the latest Stores file in links-map.json."""
...
def parse_args() -> argparse.Namespace:
	...
	parser = argparse.ArgumentParser(description="Fetch and normalize CARREFOUR branches")
...
def decode_payload(raw: bytes) -> str:
	...
	# Carrefour stores payloads can be UTF-8, UTF-16 (with BOM), or legacy Hebrew encodings.
